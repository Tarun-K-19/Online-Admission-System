...
$sta = mysqli_query($con, "select s_stat from t_status where s_id='" . $_SESSION['user_id'] . "'");
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <td colspan="2" width="3%">
                                        ...
                                        $resdata = mysqli_query($con, "SELECT * FROM t_user_data WHERE s_id='" . $_SESSION['user_id'] . "'");
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <?php
                                            if (strcmp($stval, "Approved") === 0) {
                                                echo '<li class="list-group-item"><font style="font-family: Verdana; font-size:15px;"> 4) Print Registration Card</font><p align="right" style="font-family: Verdana; font-size:15px;"><a href="admitcard.php">Click Here</a></p></li>';
                                            }
                                            ?>
