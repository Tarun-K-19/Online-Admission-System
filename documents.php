...
<body>
    <form id="docup" enctype="multipart/form-data" name="docup" action="homepageuser.php" method="post">
        ...
        <input type="submit" id="fpicup" name="fpicup" class="toggle btn btn-primary" style="margin-left:50%;">
    </form>
</body>
