...
<body style="background-image:url('./images/inbg.jpg');">
    <form id="signup" action="signupconfirm.php" method="post">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <img src="images/sign-up-bg.jpg" width="100%" margin-top:0px; style="position: absolute;"></img>
                </div>
            </div>
        </div>
        <div id="dmid">
        ...
        <div id="ddown" style="margin-left:100px; position:relative">
            <br><br><br>
            <div id="dleft">
                <input type="hidden" id="stid" name="stid" value="">
                <input type="hidden" id="stpw" name="stpw" value="">
                <img src="images/sign-up-side.jpg" style="height:470px;width:550px;border-top-left-radius:15px;border-bottom-left-radius:15px;"></img>
            </div>
            <div id="drig" style="background: white; opacity: .7;">
                <br>
                ...
                <table id="tabintro">
                    ...
                    <tr>
                        <td>
                            <a href="index.php" style="margin-top: 8px;margin-left:30px;" class="toggle btn btn-primary">Back </a>
                            ...
                            <a href="index.php" style="margin-top: 8px;margin-left:90px;" class="toggle btn btn-primary">Login </a>
                        </td>
