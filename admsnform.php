...
<body style="background-image:url('./images/inbg.jpg');">
    <form id="adform" action="admsnform.php" method="post">
        ...
        <table class="frmtbl">
            ...
            <tr>
                <td>
                    <font style="font-family: Verdana;">Name of college</font>
                </td>
                <td><select id="cen" name="cen">
                        <option>--------------------Select--------------------</option>
                        <option>CIT Main Campus</option>
                        <option>SIT Main Campus</option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="radio" id="moi" name="moi" value="Kannada">
                    <font style="font-family: Verdana;">Kannada</font>
                    ...
                    <input type="radio" id="moi" name="moi" value="Tamil">
                    <font style="font-family: Verdana;">Tamil</font>
