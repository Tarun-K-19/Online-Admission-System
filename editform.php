...
where s_id='" . $_SESSION['user_id'] . "'";

    $sql1 = "update t_user_data set s_name='$unam' where s_id='" . $_SESSION['user_id'] . "'";
            ...
            ?>
                ...
                <tr>
                    <td colspan="4"><input type="radio" id="cat" name="cat" value="SC">
                        <font style="font-family: Verdana;">
                            ...
                            <input type="radio" id="cat" name="cat" value="SC">
                            <font style="font-family: Verdana;">SC</font>
                ...
                <tr>
                    ...
                    <td><select id="col" name="col">
                            ...
                            <option>Channabasaveshwara Institute Of Technology</option>
