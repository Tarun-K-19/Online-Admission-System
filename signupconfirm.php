...
{
    $con = mysqli_connect("localhost", "root", "password", "oas");
...
<body style="background-image:url('./images/inbg.jpg');">
    <form id="signupconfirm" action="signupconfirm.php" method="post">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <img src="images/long-logo.png" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                </div>
            </div>
        </div>
        <div id="dmid">
            ...
            <div id="drig">
                ...
                <center>
                    <font style="color: #3399ff; margin-left:30px; font-family: Verdana;font-size:20px;">
                        ...
                        You are successfully registered. Please check your email ID or Phone for User ID and Password. <br>You can take Screenshot of this page to save your password for furthrer endovers</font>
                </center>
                <br><br>
